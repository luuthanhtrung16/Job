...
@section('title','Employer_single')
@section('content')
    <ol class="breadcrumb justify-content-left">
        <li class="breadcrumb-item">
            <a href="index.html">Home</a>
        </li>
        <li class="breadcrumb-item active">Employer Single</li>
    </ol>
    <!-- banner-text -->
    <!--/process-->
            ...
            <div class="inner-sec-w3ls py-lg-5  py-3">
                <div class="single-user-candidate">
                    <div class="user-detail-info text-center">
                        <div class="user-pic">
                            <img src="images/b2.jpg" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="user-content-info emply-resume-info text-center mt-4">
                            ...
                            <p>
                                <i class="fas fa-map-marker-alt"></i> Sacramento, California</p>
                            <div class="skills-info my-4">
                                <span>Applications 1</span>
                                <span class="mx-3">Post Date: Month 00 00</span>
                                <span>Views 5683</span>
                            </div>
